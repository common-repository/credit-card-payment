 ...
 *
 * @wordpress-plugin
 * Plugin Name:       PayPal Credit Card Payment
...
if (!defined('CREDIT_CARD_PAYMENT_PLUGIN_BASENAME')) {
    define('CREDIT_CARD_PAYMENT_PLUGIN_BASENAME', plugin_basename(__FILE__));
}
