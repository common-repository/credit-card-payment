...
/**
 * @class       Donation_Button_Html_output
 * @version	1.0.0
 * @package	credit-card-payment-gateway
 * @category	Class
 * @author      @author     mbj-webdevelopment <mbjwebdevelopment@gmail.com>
 */
class Credit_Card_Payment_Html_output {

    public static function init($options = array()) {
        if (!empty($options)) {
            foreach ($options as $value) {
                $psc_custom_class_added = '';
                if ("credit_card_payment_custom_button_general_settings" == $value['id']) {
                    $psc_custom_class_added = 'class_pccg_custom_button';
                }
                if (!isset($value['type'])) {
                    continue;
                }
                ...
                if ($description && in_array($value['type'], array('textarea', 'radio'))) {
                    ...
                    $description = '<span class="description ' . $psc_custom_class_added . '">' . wp_kses_post($description) . '</span>';
                }
                    ...
                    case 'password' :
                        ...
                        ?><tr valign="top">
                            <th scope="row" class="titledesc">
                                <label for="<?php echo esc_attr($value['id']); ?>"  class="<?php echo esc_attr($psc_custom_class_added); ?>"><?php echo esc_html($value['title']); ?></label>
                                <?php echo $tip; ?>
                            </th>
                            <td class="forminp forminp-<?php echo sanitize_title($value['type']) ?>">
                                <input
                                    ...
                                    class="<?php echo esc_attr($value['class'] . ' ' . $psc_custom_class_added); ?>"
...
Credit_Card_Payment_Html_output::init();