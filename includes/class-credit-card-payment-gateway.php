...
class Credit_Card_Payment_Gateway {
    ...
    public function __construct() {
        ...
        add_filter("{$prefix}plugin_action_links_" . CREDIT_CARD_PAYMENT_PLUGIN_BASENAME, array($this, 'credit_card_payment_plugin_action_links'), 10, 4);
    }
    ...
    public function credit_card_payment_plugin_action_links($actions, $plugin_file, $plugin_data, $context) {
        $custom_actions = array(
            'configure' => sprintf('<a href="%s">%s</a>', admin_url('options-general.php?page=credit-card-payment'), __('Configure', 'donation-button')),
            'docs' => sprintf('<a href="%s" target="_blank">%s</a>', 'https://www.premiumdev.com/product/credit-card-payment/', __('Docs', 'donation-button')),
            'support' => sprintf('<a href="%s" target="_blank">%s</a>', 'https://wordpress.org/support/plugin/credit-card-payment', __('Support', 'donation-button')),
            'review' => sprintf('<a href="%s" target="_blank">%s</a>', 'https://wordpress.org/support/view/plugin-reviews/credit-card-payment', __('Write a Review', 'donation-button')),
        );
